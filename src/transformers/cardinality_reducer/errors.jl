...
COLLISION_NEW_VAL(value) =
    "In CardinalityReducer, label_for_infrequent specifies new feature name $(value). However, this name already exists in one of the features. Please respecify label_for_infrequent."
